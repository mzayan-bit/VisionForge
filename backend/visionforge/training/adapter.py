...
class YOLODataStoreAdapter:
    ...
    def __init__(self, output_root: str | None = None):
        raw_path = output_root or (Path(get_settings().model_cache_dir).parent / "training" / "datasets")
